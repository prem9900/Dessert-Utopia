...
const NavLinks = ({ to, label }) => {
    return (_jsx(StyledMenuItem, { children: _jsxs(RouterNavLink, { to: to, style: { textDecoration: "none", color: "inherit" }, className: ({ isActive }) => (isActive ? "active" : ""), children: [_jsx(StyledLink, { children: label }), " "] }) }));
};
